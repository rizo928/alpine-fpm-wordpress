...
Initial version of Dockerfile pulled directly from official Wordpress 7.1-fpm-alpine git.
...
```console
$ docker run --name some-wordpress --link some-mysql:mysql -d rizo928/wordpress
```
...
```console
$ docker run --name some-wordpress --link some-mysql:mysql -p 8080:80 -d rizo928/wordpress
```
...
$ docker run --name some-wordpress -e WORDPRESS_DB_HOST=10.1.2.3:3306 \
    -e WORDPRESS_DB_USER=... -e WORDPRESS_DB_PASSWORD=... -d rizo928/wordpress
```
